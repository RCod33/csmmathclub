...
% \begin{problem}[C][3] idk what i was doing here
%     In Fivetown, every person must have a phone and therefore a phone number. Every phone number must be a 5-digit number where each digit is a value between 0 and 9 inclusive. However 0000 is not a valid license plate. What is the minimum population of Fourtown to guarantee that at least two people have the same license plate??
% \end{problem}
